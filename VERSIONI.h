...
================================================================================================================================================================
  -- CAMBIO VERSIONI : SA QUI PARTE LA VERSIONE CON INTERFACCIA WEB --

070616-W => Versione operativa non ancora testata per R4 wifi. Il sistema identico al precedente solo con parte wifi: arduino è AP e collegandosi
            da tel/pc/piccione viaggiatore si puo usare l'intefaccia come show dati e "telecomando" per avviare l'irrigazione automatica, per il 
            momento solo di tutte le zone (gia avviata idea per mettere anche le single zone). 
            Lo sketch usa 93096 byte (35%) dello spazio disponibile per i programmi. Il massimo è 262144 byte.
            Le variabili globali usano 10028 byte (30%) di memoria dinamica, lasciando altri 22740 byte liberi per le variabili locali. Il massimo è 32768 byte.
...
char VERSIONE[9] = "060626-W"; // FORMATTAZIONE : ggmmaa 
